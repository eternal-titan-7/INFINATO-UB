...
async def repo(e):
    res = [
        await e.builder.article(
            title="Infinato Userbot",
            description="Userbot | Telethon",
            thumb=wb(ultpic, 0, "image/jpeg", []),
            text="• **INFINATO** •",
            buttons=[
                [Button.url("Repo", url="https://github.com/coolfoolunidentifiedhacker/INFINATO-UB")],
                [
                    Button.url(
    ...
    await e.answer(res, switch_pm="INFINATO REPO[SITORY]", switch_pm_param="start")
