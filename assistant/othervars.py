...
async def update(eve):
    ...
    if Var.HEROKU_API:
        ...
        execl(sys.executable, sys.executable, "-m", "infinatoUserbot")
...
async def _(e):
    ...
    await e.reply(
        "`Success!\nYou are all set to use Google Drive with INFINATO.`",
...
async def _(e):
    ...
    async with infinato_bot.asst.conversation(e.sender_id) as conv:
...
async def otvaar(event):
    await event.edit(
        "Other Variables to set for INFINATO:",
        buttons=[
            [
